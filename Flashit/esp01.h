...
// 3 GPIO02 General purpose Input/output pin. Also used as SDA for I2C when OLED defined
// 4 CH_EN Chip Enable – Active high
// 5 GPIO00 Flash. General purpose Input/output.  If hold LOW while switch on takes module into serial programming. Also used as SCL for I2C when OLED defined
// 6 Reset the ESP8266
